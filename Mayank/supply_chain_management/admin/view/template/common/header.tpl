...
<div id="container">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li> <a href="<?php echo $custom_manufacture; ?>" class="top">Manufacturer</a></li>
      <li> <a href="<?php echo $custom_product; ?>" class="top">Products</a></li>
      <li> <a href="<?php echo $custom_category; ?>" class="top">Category</a></li>
      <li> <a href="<?php echo $custom_order; ?>" class="top">Order</a></li>
      <li> <a href="<?php echo $custom_return; ?>" class="top">Returns</a></li>
      <li> <a href="<?php echo $custom_customer; ?>" class="top">Customers</a></li>
      <li> <a href="<?php echo $custom_user; ?>" class="top">Dealers</a></li>
